...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (!new java.io.File(propsPath).exists()) {
            propsPath = "src/metrics.properties"; // if run from singleton-metrics
        }
        if (!new java.io.File(propsPath).exists()) {
            propsPath = "singleton-metrics/src/metrics.properties"; // if run from workspace root
        }
